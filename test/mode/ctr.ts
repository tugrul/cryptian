...
const {algorithm: {Dummy}, mode: {ctr}} = cryptian;

(typeof ctr === 'object' ? describe : describe.skip) ('ctr', () => {
    ...
    describe('cipher', () => {
        ...
        it('getBlockSize', () => {
            const cipher = new ctr.Cipher(dummy, iv);
    ...
    describe('decipher', () => {
        ...
        it('getBlockSize', () => {
            const decipher = new ctr.Decipher(dummy, iv);
