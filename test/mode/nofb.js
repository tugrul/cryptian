...
describe('nofb', () => {
    ...
    it('should have namespace', () => {
        assert(typeof mode.nofb === 'object', 'there is no namespace');
    });

    it('should be constructor', () => {
        assert(typeof mode.nofb.Cipher === 'function', 'there is no Cipher constructor');
        assert(typeof mode.nofb.Decipher === 'function', 'there is no Decipher constructor');
    });


    const plaintext  = new Buffer('88cc3d134aee5660f7623cf475fe9df20f773180bd70b0ef2aae00910ba087a1', 'hex');
    const ciphertext = new Buffer('ace98b99e6803c44d3478a7ed990f7d62b52870a111edacb0e8bb61ba7ceed85', 'hex');
    ...
    it('should do cipher and decipher operations', () => {
        ...
        describe('cipher undivided', () => {
            const cipher = new mode.nofb.Cipher(dummy, iv);
        ...
        describe('decipher undivided', () => {
            const decipher = new mode.nofb.Decipher(dummy, iv);
