...
describe('cfb', () => {
    ...
    it('should have namespace', () => {
        assert(typeof mode.cfb === 'object', 'there is no namespace');
    });

    it('should be constructor', () => {
        assert(typeof mode.cfb.Cipher === 'function', 'there is no Cipher constructor');
        assert(typeof mode.cfb.Decipher === 'function', 'there is no Decipher constructor');
    });
    ...
    describe('cipher', () => {
        ...
        it('getBlockSize', () => {
            const cipher = new mode.cfb.Cipher(dummy, iv);
        ...
        it('divided 13', () => {
            ...
            const part = Buffer.concat([
                ...
                cipher.transform(plaintext.slice(13))
            ]);
    ...
    describe('decipher', () => {
        ...
        it('getBlockSize', () => {
            const decipher = new mode.cfb.Decipher(dummy, iv);
        ...
        it('divided 13', () => {
            ...
            const part = Buffer.concat([
                ...
                decipher.transform(ciphertext.slice(13))
            ]);
