...
describe('wake', () => {
    ...
    it('should do encrypt and decrypt operations', () => {
        ...
        describe('encrypt', () => {
            ...
            assert(ciphertext.equals(wake.encrypt(plaintext)), 'encrypted plaintext should be equal to ciphertext');
        });
        ...
        describe('decrypt', () => {
            ...
            assert(plaintext.equals(wake.decrypt(ciphertext)), 'decrypted ciphertext should be equal to plaintext');
        });
