...
std::string Cast256::getName() {
    return "CAST-256";
}

std::size_t Cast256::getVersion() {
    return 20010801;
}

std::size_t Cast256::getBlockSize() {
    return 16;
}

std::vector<std::size_t> Cast256::getKeySizes() {
    return {16, 24, 32};
}

std::vector<char> Cast256::encrypt(const std::vector<char> plaintext) {
	...
	f_rnd(t, u, ciphertext.ui, 0);
	f_rnd(t, u, ciphertext.ui, 8);
	f_rnd(t, u, ciphertext.ui, 16);
	f_rnd(t, u, ciphertext.ui, 24);
	f_rnd(t, u, ciphertext.ui, 32);
	f_rnd(t, u, ciphertext.ui, 40);
	i_rnd(t, u, ciphertext.ui, 48);
	i_rnd(t, u, ciphertext.ui, 56);
	i_rnd(t, u, ciphertext.ui, 64);
	i_rnd(t, u, ciphertext.ui, 72);
	i_rnd(t, u, ciphertext.ui, 80);
	i_rnd(t, u, ciphertext.ui, 88);
...
std::vector<char> Cast256::decrypt(const std::vector<char> ciphertext) {
	...
	f_rnd(t, u, plaintext.ui, 88);
	f_rnd(t, u, plaintext.ui, 80);
	f_rnd(t, u, plaintext.ui, 72);
	f_rnd(t, u, plaintext.ui, 64);
	f_rnd(t, u, plaintext.ui, 56);
	f_rnd(t, u, plaintext.ui, 48);
	i_rnd(t, u, plaintext.ui, 40);
	i_rnd(t, u, plaintext.ui, 32);
	i_rnd(t, u, plaintext.ui, 24);
	i_rnd(t, u, plaintext.ui, 16);
	i_rnd(t, u, plaintext.ui, 8);
	i_rnd(t, u, plaintext.ui, 0);
...
void Cast256::reset() {
    ...
    unsigned int i, j, t, u, cm, cr, tm[8], tr[8];

	for (i = 0; i < _key.size() / sizeof(unsigned int); i++) {
...
const unsigned int Cast256::cast256_sbox[4][256] = { {
