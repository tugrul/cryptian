...
std::string Tripledes::getName() {
    return "3DES";
}

std::size_t Tripledes::getVersion() {
    return 19991129;
}

std::size_t Tripledes::getBlockSize() {
    return 8;
}

std::vector<std::size_t> Tripledes::getKeySizes() {
    return {24};
}
...
void Tripledes::reset() {
    ...
    for (size_t times = 0; times < 3; times++) {
    	...
    	for (j = 0; j < 56; j++) {	// convert pc1 to bits of key
    		...
    		m = l & 07;	// find bit
    		pc1m[j] = (_key[(times * 8) + (l >> 3)] &	// find which key byte l is in
...
void Tripledes::spinit(unsigned int (&sp)[8][64]) {
...
const char Tripledes::totrot[16] = {
	1, 2, 4, 6, 8, 10, 12, 14, 15, 17, 19, 21, 23, 25, 27, 28
};

/* permuted choice key (table) */
const char Tripledes::pc2[48] = {
	14, 17, 11, 24, 1, 5,
	3, 28, 15, 6, 21, 10,
	23, 19, 12, 4, 26, 8,
	16, 7, 27, 20, 13, 2,
...
const int Tripledes::bytebit[8] = {
	0200, 0100, 040, 020, 010, 04, 02, 01
};

const int Tripledes::nibblebit[4] = {
	010, 04, 02, 01
};
